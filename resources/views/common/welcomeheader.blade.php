...
<div class="fixed top-0 w-full bg-white shadow flex items-center px-4 py-2">
    ...
    <div class="flex items-center">
        ...
        <div data-mesh-id="comp-ki7i1ojainlineContent" data-testid="inline-content" class=""><div data-mesh-id="comp-ki7i1ojainlineContent-gridContainer" data-testid="mesh-container-content"><div id="comp-ki79rmsk" class="comp-ki79rmsk wixui-vector-image"><a data-testid="linkElement" target="_self" class="a9YhBi"><div data-testid="svgRoot-comp-ki79rmsk" class="AKxYR5 VZYmYf comp-ki79rmsk"><!--?xml version="1.0" encoding="UTF-8"?-->
            <svg preserveAspectRatio="xMidYMid meet" data-bbox="10.411 30.955 178.189 136.945" viewBox="10.411 30.955 178.189 136.945" height="30" width="30" xmlns="http://www.w3.org/2000/svg" data-type="color" role="img" aria-label="Homepage"><defs><style>#comp-ki79rmsk svg [data-color="1"] {fill: #BA9247;}</style></defs>
                <g>
            ...
            </div></a></div><div id="comp-ki79nl5d" class="HcOXKn SxM0TO QxJLC3 comp-ki79nl5d wixui-rich-text" data-testid="richTextElement"><p class="font_3 wixui-rich-text__text" style="font-size:20px;">T.B.L</a></p></div></div></div>
    </div>
